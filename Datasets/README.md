...
* **Mortalidad:** Número absoluto de suicidios (`suicides_no`), población total del grupo (`population`), y la métrica estandarizada de suicidios por cada 100,000 habitantes para permitir comparaciones justas entre países de distinto tamaño.
...
Dentro del macro-tema de la mortalidad, este dataset nos permite explorar la **dimensión socioeconómica y demográfica**. La variedad de datos continuos y categóricos nos da la flexibilidad necesaria para desarrollar cruces de variables poco comunes, superando los análisis tradicionales y facilitando la creación de visualizaciones complejas y de alto impacto sobre un problema de salud pública global.